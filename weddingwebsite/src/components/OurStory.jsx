...
<div className='content'>
  ...
  <p style={{ margin: '10px 0' }}>
    All jokes aside, we've finally reached the moment where we're about to start our new lives together. <br/>
    It's been a rollercoaster of emotions for both us and our families, but we can't wait to celebrate it all with our loved ones.<br/>
  </p>
  <p style={{ margin: '10px 0' }}>
